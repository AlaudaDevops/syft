...
# sonarqube-cli >= v0.3.0 refuses a plain-http endpoint unless SONARQUBE_ALLOW_HTTP=true.
# The e2e SonarQube instances are reached over in-cluster http, so default to allowing it;
# set SONARQUBE_ALLOW_HTTP=false to restore the cli's https-only enforcement.
SONARQUBE_ALLOW_HTTP ?= true
...
prepare-sonarqube-data: export SONARQUBE_ALLOW_HTTP := $(SONARQUBE_ALLOW_HTTP)
...
clean-sonarqube-data: export SONARQUBE_ALLOW_HTTP := $(SONARQUBE_ALLOW_HTTP)
